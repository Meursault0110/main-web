...
Astro Sphere is a static, minimalist, lightweight, lightning fast portfolio and mydocs theme based on my personal website.
...
The mydocs posts on the demo serve as the documentation and configuration.
